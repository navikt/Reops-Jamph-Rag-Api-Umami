...
class EndToEndTimer(
    private val ragService: RagV2SqlService
) {
    private val logger = LoggerFactory.getLogger(EndToEndTimer::class.java)

    suspend fun measureFullPipeline(query: String, url: String): EndToEndTimerResult {
        ...
        val sql = ragService.generateSql(query, url)  // Full pipeline: ragV2
